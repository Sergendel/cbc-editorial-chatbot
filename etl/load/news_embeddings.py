...
def generate_news_embeddings(article_json: dict, embedding_model_funciton):
    ...
    embeddings_with_metadata.append(
        {
            "embedding": embedding_model_funciton(article_text.strip()),
            "metadata": {
    ...
    for sentence in sentences:
        ...
        embeddings_with_metadata.append(
            {
                "embedding": embedding_model_funciton(clean_sentence),
                "metadata": {
